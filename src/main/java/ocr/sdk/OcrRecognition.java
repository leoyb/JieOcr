...
public class OcrRecognition {
    ...
    public List<DetectedObjects.DetectedObject> recognizeImg(Image image) throws TranslateException, InterruptedException {
        ...
        tasks.add(new ImgTask(ImgTask.price, image, rectangle0, detectionModel, recognitionModel));
        tasks.add(new ImgTask(ImgTask.score, image, rectangle1, detectionModel, recognitionModel));
        tasks.add(new ImgTask(ImgTask.score, image, rectangle2, detectionModel, recognitionModel));
        tasks.add(new ImgTask(ImgTask.score, image, rectangle3, detectionModel, recognitionModel));
        tasks.add(new ImgTask(ImgTask.score, image, rectangle4, detectionModel, recognitionModel));
